...
export default class JSerPostingCountContainer extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="JSerPostingCountContainer" className="JSerPostingCountContainer panel panel-default">
                ...
                <BootstrapTable data={data} options={options} pagination exportCSV>
                    <TableHeaderColumn dataField="id" isKey={true} dataSort={true} hidden>
                        ID
                    </TableHeaderColumn>
