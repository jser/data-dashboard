        ...
        return (
            <div className="App">
                <header className="App-header">
                    ...
                    <p>
                        <a href="https://jser.info/">JSer.info</a>
                        の統計データを集約したダッシュボード
                    </p>
                    <div className="App-index panel panel-default">
                        ...
                        <div className="panel-body">
                            <dl>
                                <dt>アイテム</dt>
                                <dd>
                                    紹介したサイト(URLや関連URLを含め)のことを1アイテムとしています。
                                    <a href="https://github.com/jser/stat-js">jser/stat-js</a>
                                    を参照
                                </dd>
                ...
                <ul className="nav nav-pills">
                    <li role="presentation">
                        <a href="#ItemCountPerPostContainer">紹介アイテム数</a>
                    </li>
                    <li role="presentation">
                        <a href="#TagStateRankingPerMonthContainer">タグ(総数)</a>
                    </li>
                    <li role="presentation">
                        <a href="#AverageTagStateRankingPerMonthContainer">タグ(平均)</a>
                    </li>
                    <li role="presentation">
                        <a href="#DomainRankingContainer">ドメイン</a>
                    </li>
                    <li role="presentation">
                        <a href="#JSerPostingCountContainer">投稿記事数</a>
                    </li>
                </ul>
