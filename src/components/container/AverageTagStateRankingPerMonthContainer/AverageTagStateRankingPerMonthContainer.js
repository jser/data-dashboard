...
export default class AverageTagStateRankingPerMonthContainer extends React.Component {
            ...
            Object.entries(currentGroup)
                ...
                .map(item => {
                    return {
                        id: item.id,
                        name: item.name,
                        現在: item["現在"] > 0 ? item["現在"] / currentWeek.length : 0,
                        一ヶ月前: item["一ヶ月前"] > 0 ? item["一ヶ月前"] / prevOneMonthWeek.length : 0,
                        三ヶ月前: item["三ヶ月前"] > 0 ? item["三ヶ月前"] / prevThreeMonthWeek.length : 0,
                        六ヶ月前: item["六ヶ月前"] > 0 ? item["六ヶ月前"] / prevHalfYearMonthWeek.length : 0,
                        一年前: item["一年前"] > 0 ? item["一年前"] / prevOneYearWeek.length : 0
                    };
                }),
            "現在"
        ).reverse();
    ...
    render() {
        ...
        return (
            <div
                id="AverageTagStateRankingPerMonthContainer"
            ...
            >
                ...
                <p className="panel-body">
                    投稿した記事で紹介したアイテムにつけたタグの個数の平均を算出(タグ数 / 記事数)
                </p>
